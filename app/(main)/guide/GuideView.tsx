...
const sections = [
  {
    title: 'はじめに',
    items: [
      { q: 'ログイン方法', a: 'iPhone の ブラウザ（インターネットを見るアプリ）で yadocho.com を開き、メールアドレスとパスワードを入力して「ログイン」をタップ（指で軽く触れる）します。' },
      { q: 'ホーム画面に追加するには', a: '宿帳を開いた状態で、ブラウザ の画面下にある「共有」ボタン（□に↑のマーク）をタップ →「ホーム画面に追加」→「追加」をタップすると、次からはホーム画面のアイコンをタップするだけで開けます。' },
    ],
  },
  {
    title: '基本の流れ',
